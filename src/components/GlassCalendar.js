...
import "./GlassCalendarStyles.css";
...
function GlassCalendar(props) {
    ...
    const previousMonth = () => {
        ...
        if (!(month === 11 && currentYear === 1970)) updateMonth(month);
    };
    const nextMonth = () => {
                    ...
                    <div
                        ...
                        onClick={(e) => {
                            ...
                            if (props.onDaySelect)
                                props.onDaySelect(Date(e.target.getAttribute("date")));
                        }}
                        onKeyPress={(e) => {
    ...
    return daysInMonthLayout(currentMonth, currentYear)
}
